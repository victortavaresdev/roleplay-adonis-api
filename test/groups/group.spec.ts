...
test.group('Group', (group) => {
  ...
  test('it should update an group', async (assert) => {
  ...
  test('it should remove user from group', async (assert) => {
    ...
    let playerToken = response.body.token.token
  ...
  test('it should return all groups when no query is provided to list groups', async (assert) => {
    ...
    assert.exists(body.groups, 'Groups underfined')
    ...
    assert.exists(body.groups.data[0].masterUser, 'MasterUser undefined')
  ...
  test('it should return all groups by user id', async (assert) => {
    ...
    assert.exists(body.groups[0].masterUser, 'MasterUser undefined')
